...
public final class MaxAndMin {
	...
	public static final int AP_COVERAGE =1000; //1000; //Max Ap coverage distance - It should modify
	public static final int CLOUDLET_COVERAGE = 1000; //Max cloudlet distance - It should modify
	public static final int MAX_DISTANCE_TO_HANDOFF =101; //40; //It cannot be less than Max_SPEED
	...
	public static final int MAX_X = 16000;//16000
	public static final int MAX_Y = 16000;//16000
	...
	public static final int MAX_SIMULATION_TIME = 1000*60*2500; // 1000*60*2500  30 minutes
