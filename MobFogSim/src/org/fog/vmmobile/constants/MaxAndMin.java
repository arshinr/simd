...
public final class MaxAndMin {
	...
	public static final int MAX_DISTANCE_TO_HANDOFF =100; //40; //It cannot be less than Max_SPEED
	...
	public static final int MAX_SIMULATION_TIME = 1000*60*10; // 1000*60*2500  30 minutes
